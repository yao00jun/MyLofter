...
class LofterModel(models.Model):
    ...
    image = models.ImageField(null=True, blank=True,default="courses/2017/09/p1.jpg", upload_to="courses/%Y/%m", verbose_name=u"封面图", max_length=100)
    #content = models.TextField(verbose_name=u"文章内容")
    content = UEditorField(u'内容详情', width=750, height=300, imagePath="ueditor/", filePath="ueditor/", upload_settings={"imageMaxSize":1204000}, default="")
